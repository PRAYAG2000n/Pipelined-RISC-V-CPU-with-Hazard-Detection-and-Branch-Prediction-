# Pipelined RISC-V CPU with hazard detection and branch prediction
...
Simulation, waveform generation, and coverage reporting are automated using **ModelSim / QuestaSim** with `run_sim.tcl`.
...
-  **Control Hazards:** Managed with a simple **1-bit branch predictor (BPU)**  
...
## Output
<pre> <code> Starting RISC-V CPU Simulation...
